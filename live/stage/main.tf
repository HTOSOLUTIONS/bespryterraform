...
locals {
  ...
  dotnet_api_aws_env = {
    ...
    "AWS__Logging__Info"        = local.api_logging.Info
...
# 1) ACM cert for api.$(env).bespry.net, DNS-validated in Route53
module "api_cert" {
...
moved {
  from = module.api_cert.aws_acm_certificate.this
  to   = module.api_cert[0].aws_acm_certificate.this
}

moved {
  from = module.api_cert.aws_acm_certificate_validation.this
  to   = module.api_cert[0].aws_acm_certificate_validation.this
}

moved {
  from = module.api_cert.aws_route53_record.validation["api.stage.bespry.net"]
  to   = module.api_cert[0].aws_route53_record.validation["api.stage.bespry.net"]
}
