...
# Permanent: allow PostgreSQL from EB instances SG only
...
resource "aws_vpc_security_group_ingress_rule" "from_dev_cidr" {
  ...
  description = "TEMP PostgreSQL from developer machine"
}
...
resource "aws_db_instance" "this" {
  ...
  # Note: db_name is valid for RDS Postgres (initial database created)
  db_name  = var.db_name
